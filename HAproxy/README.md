...
For SSH Authentication
 1. Login to management machine : vagrant ssh mgmt
 2. Create ssh key: ssh-keygen -t rsa -b 2048
 3. Scan keys of all servers and copy to mgmt node: ssh-keyscan lbserver webserver1 webserver2 dbserver nagios >> .ssh/known_hosts
 4. ansible-playbook add-ssj-key.yml --ask-pass
    Password: vagrant 
